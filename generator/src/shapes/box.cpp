...
std::vector<Vertex> Box::calculateCoords() const {
    ...
    for (size_t j = 0; j < n_divisions; ++j) {
        for (size_t k = 0; k < n_divisions; ++k) {
            ...
            auto t1 = Vec2(t_base.x() - i1.x() / 4.0f, t_base.y() + i1.y() / 3.0f);

            auto p2 =
                starting_point + length * Vec3::cartesian(i2.x(), 0, i2.y());
            auto t2 = Vec2(t_base.x() - i2.x() / 4.0f, t_base.y() + i2.y() / 3.0f);

            auto p3 =
                starting_point + length * Vec3::cartesian(i3.x(), 0, i3.y());
            auto t3 = Vec2(t_base.x() - i3.x() / 4.0f, t_base.y() + i3.y() / 3.0f);

            auto p4 =
                starting_point + length * Vec3::cartesian(i4.x(), 0, i4.y());
            auto t4 = Vec2(t_base.x() - i4.x() / 4.0f, t_base.y() + i4.y() / 3.0f);
            ...
            // Top triangles
            p1.set_y(length / 2);
            t1 = Vec2(t_top.x() - i1.x() / 4.0f, t_top.y() - i1.y() / 3.0f);

            p2.set_y(length / 2);
            t2 = Vec2(t_top.x() - i2.x() / 4.0f, t_top.y() - i2.y() / 3.0f);

            p3.set_y(length / 2);
            t3 = Vec2(t_top.x() - i3.x() / 4.0f, t_top.y() - i3.y() / 3.0f);

            p4.set_y(length / 2);
            t4 = Vec2(t_top.x() - i4.x() / 4.0f, t_top.y() - i4.y() / 3.0f);
            ...
            t1 = Vec2(t_right.x() + i1.x() / 4.0f, t_right.y() + i1.y() / 3.0f);

            p2 = starting_point + length * Vec3::cartesian(i2.x(), i2.y(), 0);
            t2 = Vec2(t_right.x() + i2.x() / 4.0f, t_right.y() + i2.y() / 3.0f);

            p3 = starting_point + length * Vec3::cartesian(i3.x(), i3.y(), 0);
            t3 = Vec2(t_right.x() + i3.x() / 4.0f, t_right.y() + i3.y() / 3.0f);

            p4 = starting_point + length * Vec3::cartesian(i4.x(), i4.y(), 0);
            t4 = Vec2(t_right.x() + i4.x() / 4.0f, t_right.y() + i4.y() / 3.0f);
            ...
            // Left triangles
            p1.set_z(length / 2);
            t1 = Vec2(t_left.x() + i1.x() / 4.0f, t_left.y() + i1.y() / 3.0f);

            p2.set_z(length / 2);
            t2 = Vec2(t_left.x() + i2.x() / 4.0f, t_left.y() + i2.y() / 3.0f);

            p3.set_z(length / 2);
            t3 = Vec2(t_left.x() + i3.x() / 4.0f, t_left.y() + i3.y() / 3.0f);

            p4.set_z(length / 2);
            t4 = Vec2(t_left.x() + i4.x() / 4.0f, t_left.y() + i4.y() / 3.0f);
            ...
            t1 = Vec2(t_back.x() + i1.x() / 4.0f, t_back.y() + i1.y() / 3.0f);

            p2 = starting_point + length * Vec3::cartesian(0, i2.x(), i2.y());
            t2 = Vec2(t_back.x() + i2.x() / 4.0f, t_back.y() + i2.y() / 3.0f);

            p3 = starting_point + length * Vec3::cartesian(0, i3.x(), i3.y());
            t3 = Vec2(t_back.x() + i3.x() / 4.0f, t_back.y() + i3.y() / 3.0f);

            p4 = starting_point + length * Vec3::cartesian(0, i4.x(), i4.y());
            t4 = Vec2(t_back.x() + i4.x() / 4.0f, t_back.y() + i4.y() / 3.0f);
            ...
            // Front triangles
            p1.set_x(length / 2);
            t1 = Vec2(t_front.x() - i1.x() / 4.0f, t_back.y() + i1.y() / 3.0f);

            p2.set_x(length / 2);
            t2 = Vec2(t_front.x() - i2.x() / 4.0f, t_back.y() + i2.y() / 3.0f);

            p3.set_x(length / 2);
            t3 = Vec2(t_front.x() - i3.x() / 4.0f, t_back.y() + i3.y() / 3.0f);

            p4.set_x(length / 2);
            t4 = Vec2(t_front.x() - i4.x() / 4.0f, t_back.y() + i4.y() / 3.0f);
